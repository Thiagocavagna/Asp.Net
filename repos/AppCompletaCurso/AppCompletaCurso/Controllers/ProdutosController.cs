...
using AppCompletaCurso.Data;
using AppCompletaCurso.Models;

namespace AppCompletaCurso.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            //TempData["FornecedorId"] = new SelectList(_context.Fornecedores, "Id", "Documento"); //dura mais 1 request, sessão de curta duração
